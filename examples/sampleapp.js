...
sampleapp.controller('samplectrl', function ($scope, vsalert, vsalertConfig) {
    ...
    $scope.alertSuccess = function () {
        vsalert.alert({level: 'success', message: 'Success message. Mauris sed libero. Suspendisse facilisis nulla in lacinia laoreet, lorem velit accumsan velit vel mattis libero nisl et sem.'});
    };

    $scope.alertInfo = function () {
        vsalert.alert({level: 'info', message: 'Info message. Suspendisse facilisis nulla.', timeout: 8000, icon: true});
    };
